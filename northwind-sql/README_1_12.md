...
> **Nota de progreso:** esta entrega cubre las preguntas 1 a 12. Las preguntas 13 a 20 se añaden en un commit posterior.

| # | Pregunta | Estado |
|---|----------|--------|
| 1 | Catálogo comercial activo | D |
| 2 | Concentración geográfica de la cartera | D |
| 3 | Alerta de reposición | D |
| 4 | Ficha completa de producto | D |
| 5 | Detalle valorizado de un pedido | D |
| 6 | Ranking de categorías por facturación | D |
| 7 | Clientes sin actividad comercial | D |
| 8 | Organigrama de la fuerza de ventas | D |
| 9 | Rejilla de cobertura categoría × año | D |
| 10 | Mapa de países: clientes frente a proveedores | D |
| 11 | Directorio unificado de contactos | D |
| 12 | Mercados con desequilibrio | D |
